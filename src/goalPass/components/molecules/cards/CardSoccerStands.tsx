...
export const CardSoccerStands = ({ soccerStand, stateMatch }: Props) => {
    ...
    <div className="w-full border border-white min-h-[194px] rounded-[15px] p-6 bg-gray-2-custom">
      ...
      <div className="mt-8">
        <div className="flex justify-between items-center">
          <p className="text-[14px] text-white font-extralight">
            ...
            <b className="font-bold">
              {formatNumber(soccerStand.tickets_sold)}
            </b>
          </p>
          {stateMatch != "finalizado" && (
            <p className="text-[14px] text-white font-extralight">
              Disponibles:{" "}
              <b className={`font-bold ${colorChip().textChip}`}>
        ...
        <div className="w-full bg-[#676767] rounded-lg h-2.5 my-2">
          <div
            style={{ width: `${soccerStand.occupancy_percentage ?? 0}%` }}
        ...
        <div className="flex justify-between items-center">
          <p className=" text-white font-extralight text-[14px]">
            <b className="font-bold">
              {formatNumber(soccerStand.occupancy_percentage)}%
            </b>{" "}
            vendido
          </p>
          <p className=" text-white font-extralight text-[14px]">
